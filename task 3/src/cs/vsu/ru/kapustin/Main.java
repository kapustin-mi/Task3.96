...
import cs.vsu.ru.kapustin.figures.Circle;
import cs.vsu.ru.kapustin.figures.Line;
import cs.vsu.ru.kapustin.figures.VerticalParabola;
...
public class Main {
    ...
    private static void checkCorrectness(Picture picture) {
        if (ProgramTest.isCorrect(picture)) {
